...
export default class UserPage extends Component {
    ...
    sendMessage = () => {
        ...
        const messageRef = database().ref('messages/conversations/' + senderUID +  '_' + receiverUID)
        const recentMessagesReceiverRef = database().ref('messages/recentMessages/' + receiverUID + '/' + senderUID)
        const recentMessagesSenderRef = database().ref('messages/recentMessages/' + senderUID + '/' + receiverUID)
        messageRef.push({
            sender: senderUID,
